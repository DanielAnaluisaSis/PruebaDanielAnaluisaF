...
export class Convert {
    public static toDataGifs(json: string): DataGifs {
        return cast(JSON.parse(json), r("DataGifs"));
    }

    public static dataGifsToJson(value: DataGifs): string {
        return JSON.stringify(uncast(value, r("DataGifs")), null, 2);
    }
}
